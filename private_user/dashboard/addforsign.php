...
<body>
  <aside class="sidebar">
    ...
    <a href="addforsign.php" id="addFileLink" class="active"><i class="fas fa-user-plus"></i> <span>Add Document</span></a>
  ...
  <script>
    ...
    document.getElementById('fileForm').addEventListener('submit', function (e) {
      ...
      fetch('uploadforsign.php', { method: 'POST', body: formData })
        .then(response => response.json())
        .then(data => {
          alert(data.message);
          if (data.success) {
