...
<body>
  <aside class="sidebar">
    ...
    <a href="add_document.php" id="addFileLink"><i class="fas fa-user-plus"></i> <span>Add Document</span></a>
    <a href="view_accepted.php" class="active"><i class="fas fa-user-check"></i> <span>View Verified Files</span></a>
